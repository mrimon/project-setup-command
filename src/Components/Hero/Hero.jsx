...
const Hero = () => {
    return (
        <div className=' rounded-3xl shadow-2xl max-w-full break-words my-2 py-10'>
            ...
            <div className='md:w-3xl mx-auto px-4 '>
                <p className='text-xl italic text-gray-700 break-words font-bold text-center'>Here we Collected all resources command to install in React project. No more need to search and go to all the resources website (Vite,React-Router, Tailwind, DaisyUI, Firebase etc) separately.</p>
            </div>
        </div>
    );
};
